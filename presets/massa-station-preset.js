  ...
  plugins: [
    createThemes({
      light: {
        ...
        info: colorLightBlue,
        success: colorBrand,
        default_primary: colorDarkBlue,
        hover_primary: colorBasicBlue,
        pressed_primary: colorLightBlue,
        disabled_primary: colorDarkGrey,
        default_secondary: colorWhite,
        hover_secondary: colorDarkBlue,
        pressed_secondary: colorDarkBlue,
        disabled_secondary: colorLightGrey,
      },
      dark: {
        ...
        info: colorDarkGrey,
        success: colorBrand,
        default_primary: colorWhite,
        hover_primary: colorLightGrey,
        pressed_primary: colorDarkGrey,
        disabled_primary: colorDarkGrey,
        default_secondary: colorDarkBlue,
        hover_secondary: colorWhite,
        pressed_secondary: colorWhite,
        disabled_secondary: colorDarkGrey,
      },
    }),
